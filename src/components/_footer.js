            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid grid-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mb-4 ">
                            <p class="flex items-center justify-center md:justify-start mb-4 mx-3 lg:justify-center" >
                                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f"
                                    class="w-2.5 mx-[3%]" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 320 512">
                        ...
                        <p class="mb-4 ">
                            <p class="flex items-center justify-center md:justify-start mb-4 mx-3 lg:justify-center" >
                                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram"
                                    class="w-3.5 mx-[3%]" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <path fill="currentColor"
